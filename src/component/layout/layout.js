...
export default function Layout() {
  ...
  return (
    <>
      <Disclosure
        as="nav"
        className="bg-gray-900 md:bg-opacity-10 border-b border-gray-900 fixed w-full z-10"
      >
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
              <div className="flex flex-shrink-0 items-center gap-2">
                <img
                  alt="mylogo"
                  src="./img/logo.png"
                  className="h-8 w-auto bg-gray-900 rounded-full"
                />
                <p className="font-belgie text-white">My Portofolio</p>
              </div>
                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        ...
                        "rounded-md px-3 py-2 text-sm font-medium hover:rounded-none"
                      )}
      ...
      <footer className="footer  bg-neutral text-neutral-content p-10">
        ...
        <nav className="flex flex-col justify-center md:items-center">
          <h6 className="footer-title">Social</h6>
          <div className="grid grid-flow-col gap-4">
            <Link to="https://www.instagram.com/rizwanalmsyah/">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <Link to="https://www.linkedin.com/in/rizwan-alamsyah/">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <Link to="https://www.youtube.com/@DenzTech-y7d">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
